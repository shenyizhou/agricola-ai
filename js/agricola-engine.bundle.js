...
const BASE_ACTIONS = [
    { id:'act_forest_3', name:'🌲 森林', acc:3, cur:3, type:'res', res:'wood' },
    { id:'act_forest_2', name:'🌳 树林', acc:2, cur:2, type:'res', res:'wood' },
    { id:'act_forest_1', name:'🌱 林地', acc:1, cur:1, type:'res', res:'wood' },
    { id:'act_clay_pit', name:'🧱 粘土坑', acc:1, cur:1, type:'res', res:'clay' },
    { id:'act_hollow', name:'🧱 泥坑', acc:2, cur:2, type:'res', res:'clay' },
    { id:'act_reed1', name:'🎋 芦苇池', acc:1, cur:1, type:'res', res:'reed' },
    { id:'act_fish', name:'🐟 钓鱼', acc:1, cur:1, type:'res', res:'food' },
    { id:'act_travel', name:'🎭 卖艺', acc:1, cur:1, type:'res', res:'food' },
    { id:'act_labor', name:'👷 临时工', type:'res', res:'food', amount:2 },
...
const ROUND_CARDS_POOL = [
    { id:'r_sheep', name:'🐑 绵羊市场', acc:1, cur:1, type:'res', res:'sheep', stage:1 },
    ...
    { id:'r_stone', name:'🪨 西矿场', acc:1, cur:1, type:'res', res:'stone', stage:2 },
    { id:'r_reno', name:'🔨 翻修+发展卡', type:'special', mode:'reno_major', stage:2 },
    { id:'r_grow', name:'👶 生儿育女', type:'special', mode:'grow', stage:2, desc:'需空房 > 人口' },
    { id:'r_boar', name:'🐗 猪市场', acc:1, cur:1, type:'res', res:'boar', stage:3 },
    { id:'r_veg', name:'🥕 蔬菜', type:'res', res:'veg', amount:1, stage:3 },
    { id:'r_cow', name:'🐮 牛市场', acc:1, cur:1, type:'res', res:'cow', stage:4 },
    { id:'r_stone2', name:'🪨 东矿场', acc:1, cur:1, type:'res', res:'stone', stage:4 },
